...
Module Syntax_Notations.
  ...
  (* Note we overload the notation and swap x y for list operations *)
  ...
  Notation "x ,++ y" := (app y x) (in custom exp at level 50, left associativity, format "x ,++ y") : mctt_scope.
