...
RocqMakefile.mk.conf: _CoqProject
	rocq makefile -f _CoqProject -o RocqMakefile.mk

# This file can be created by the user to hook into double colon rules or
# add any other Makefile code he may need
-include RocqMakefile.mk.local

# Parameters ##################################################################
#
# Parameters are make variable assignments.
# They can be passed to (each call to) make on the command line.
# They can also be put in RocqMakefile.mk.local once and for all.
...
# put in RocqMakefile.mk.local double colon rules accordingly.
# E.g. to perform some work after the all target completes you can write
#
# post-all::
# 	echo "All done!"
#
# in RocqMakefile.mk.local
#
###############################################################################
...
#
# There rules can be extended in RocqMakefile.mk.local
...
# extension points and RocqMakefile.mk.local
printenv::
	$(warning printenv is deprecated)
	$(warning write extensions in RocqMakefile.mk.local or include RocqMakefile.mk.conf)
	@echo 'COQLIB = $(COQLIB)'
...
# file you can extend the merlin-hook target in RocqMakefile.mk.local
.merlin:
	$(SHOW)'FILL .merlin'
...
# Users can create RocqMakefile.mk.local-late to hook into double-colon rules
# or add other needed Makefile code, using defined
# variables if necessary.
-include RocqMakefile.mk.local-late
